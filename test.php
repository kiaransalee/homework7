...
<form enctype="multipart/form-data" method="post">
   ...
   <?php endif; ?>
    <?php endforeach; ?>
   <div><input type="text"  name ="username" placeholder="Введите ваше имя" required="required">
  ...
  if (isset ($_POST['answer'])) {
   ...
   <?php if (!empty($_POST['username'])): ?>
     <a href ="./certificate.php?ca=<?php echo $ca;?>&name=<?php echo $_POST['username']?>">Получите сертификат</a>
   <?php endif; ?>
